...
from .views import UserViewSet, PatientProfileViewSet, DentistProfileViewSet, UserProfileView # VI CHANGE: ADDED UserProfileView
...
urlpatterns = [
    ...
    path("me/", UserProfileView.as_view(), name="user-profile"), # VI CHANGE
]
