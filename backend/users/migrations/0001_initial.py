# Generated by Django 5.1.5 on 2025-03-20 16:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('patient', 'Patient'), ('dentist', 'Dentist'), ('staff', 'Staff')], default='patient', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(default='default-dentist.png', upload_to='dentists/')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='dentist_profile', to='users.user')),
            ],
        ),
    ]
