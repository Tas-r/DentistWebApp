  ...
  return (
    <PortalLayout>
      ...
      <div className="bg-white p-6 rounded shadow mb-6">
        ...
        {uploadError && <div className="mb-4 p-3 bg-red-100 text-red-700 rounded">{uploadError}</div>}
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {documents.map((document) => (
                <tr key={document.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">{new Date(document.uploaded_at).toLocaleDateString()}</td>
