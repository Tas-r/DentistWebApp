          ...
          {conversations.length > 0 ? (
            <ul>
              {conversations.map((conversation) => (
                ...
                >
                  <p className="font-semibold">{conversation.recipient.name}</p>
        ...
        <div className="w-2/3 flex flex-col">
          {selectedConversation ? (
            <>
              {/* Conversation header */}
              <div className="p-4 border-b">
                <h2 className="font-semibold">{selectedConversation.recipient.name}</h2>
              </div>
              ...
              <form onSubmit={handleSendMessage} className="p-4 border-t">
                <div className="flex">
                  ...
                  <button
                    ...
                    className="px-4 bg-blue-600 text-white rounded-r hover:bg-blue-700 transition-colors disabled:bg-blue-300"
                  >
